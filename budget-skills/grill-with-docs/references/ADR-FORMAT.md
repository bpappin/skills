...
`docs/decisions/` and use the to-adr skill's
...
Name the file `ADR-<slug>.md` (or follow the project's existing convention
— consistency within a repo beats either default). Create the directory
