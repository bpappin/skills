...
Companion to ADR-0003, which decides how library skills *travel*. This one
decides how an agent finds the right one among many.
...
Nor do the paths help: `.agents/libraries/io.github.aughtone.types/` says
...
3. **Retrieval mechanism inside the codex.** A single markdown file an agent
   ...
   structure, and the format question from ADR-0003's index discussion
...
- ADR-0003 — how library skills travel
