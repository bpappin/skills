...
tracker (bundled: [ac-format.md](ac-format.md)): narrative, `## Acceptance Criteria`
checklist, `## References` pointing at the source ADR/PRD paths.
...
- [ ] `grep -r "Acceptance Criteria" docs/prd/` returns nothing live
