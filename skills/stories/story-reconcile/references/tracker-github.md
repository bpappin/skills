...
|---|---|
| Snapshot server → local | `scripts/gh-pull.sh [owner/repo] [OUT_DIR]` (bundled in this skill). Output: `docs/stories/<repo>-123_title-slug.md` files + `INDEX.md`, plus `docs/dimensions.md` at the docs root (project Status/Priority/etc field values + repo labels for offline picking) - all generated, never hand-edit |
