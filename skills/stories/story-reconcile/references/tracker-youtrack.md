...
|---|---|
| Snapshot server → local | `scripts/yt-pull.sh <PROJECT_KEY> docs/stories` (bundled in this skill; also usable: `search_issues` via MCP). Output: `docs/stories/<ID>.md` + `INDEX.md`, generated - never hand-edit |
