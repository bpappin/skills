...
|---|---|
| Snapshot server → local | `scripts/yt-pull.sh <PROJECT_KEY> docs/youtrack` (bundled in this skill; also usable: `search_issues` via MCP). Output: `docs/youtrack/<ID>.md` + `INDEX.md`, generated - never hand-edit |
...
Snapshot dir convention: `docs/youtrack/`. Commit it if the team wants
