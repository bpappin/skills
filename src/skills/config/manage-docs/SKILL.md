...
### 5. Migration Workflow ("migrate docs")
...
5.  **Refactor**: 
    - Convert any legacy inline metadata (e.g., `**ID:**`, `**Status:**`) into the YAML frontmatter block format at the top of the file.
    - Rename any existing `docs/issue/` directory to `docs/prd/`.
