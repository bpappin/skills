...
*   **Core Output**: The agent MUST display the **Management Commands**, followed by the full contents of [**`.skills/INDEX.md`**](./INDEX.md), and finally an invitation to ask for help on a specific skill (e.g., "Ask 'Help [skill-name]' for more details").
*   **Management Commands**:
