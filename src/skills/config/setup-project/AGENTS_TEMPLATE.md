...
1.  **Context Mapping**: You must map your context directly to the established documentation hierarchy before taking action:
    ...
    - Reference [**docs/design/**](./docs/design/README.md) when rendering UI screens or feature mockups.
    - Reference [**GAPS.md**](./docs/gap/README.md) for project roadmap and pending tasks.
