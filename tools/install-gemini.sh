...
# Gemini Skill Package & Install Tool
...
echo "   is DIFFERENT from the \"Project-Attached Skills\" model (using .agents/skills/ directory in your repo)."
echo "   Only use this if you want these skills to be available outside of a project root."
echo ""

echo "🚀 Starting Gemini Skill Installation..."
